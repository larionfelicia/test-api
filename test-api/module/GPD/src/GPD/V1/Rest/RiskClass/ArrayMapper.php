...
class ArrayMapper implements MapperInterface
{
    ...
    {   
        ...
        $this->entityPrototype = new RiskClassEntity;
    ...
    public function fetch($id)
    {
        if (!array_key_exists($id, $this->data)) {
            throw new DomainException('Risk Class not found', 404);
        }
    ...
    {
        return new RiskClassCollection($this->createCollection());
    }
    ...
    public function update($id, $data)
    {
        ...
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot update; no such risk class', 404);
        }
    ...
    {
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot delete; no such risk class', 404);
        }
