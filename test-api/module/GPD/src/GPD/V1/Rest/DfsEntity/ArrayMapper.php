...
class ArrayMapper implements MapperInterface
{
    ...
    {   
        ...
        $this->entityPrototype = new DfsEntityEntity;
    ...
    public function fetch($id)
    {
        if (!array_key_exists($id, $this->data)) {
            throw new DomainException('DfsEntity not found', 404);
        }
    ...
    {
        return new DfsEntityCollection($this->createCollection());
    }
    ...
    public function update($id, $data)
    {
        ...
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot update; no such dfs entity', 404);
        }
    ...
    {
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot delete; no such dfs entity', 404);
        }
