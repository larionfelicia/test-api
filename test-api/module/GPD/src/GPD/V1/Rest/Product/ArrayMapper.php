...
class ArrayMapper implements MapperInterface
{
    ...
    {
        return new ProductCollection($this->createCollection());
    }
    ...
    public function update($id, $data)
    {
        ...
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot update; no such product', 404);
        }
    ...
    {
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot delete; no such product', 404);
        }
