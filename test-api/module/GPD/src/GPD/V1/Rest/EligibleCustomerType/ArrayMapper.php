...
class ArrayMapper implements MapperInterface
{
    ...
    {   
        ...
        $this->entityPrototype = new EligibleCustomerTypeEntity;
    ...
    public function fetch($id)
    {
        if (!array_key_exists($id, $this->data)) {
            throw new DomainException('Eligible Customer Type not found', 404);
        }
    ...
    {
        return new EligibleCustomerTypeCollection($this->createCollection());
    }
    ...
    public function update($id, $data)
    {
        ...
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot update; no such customer type', 404);
        }
    ...
    {
        if (! array_key_exists($id, $this->data)) {
            throw new DomainException('Cannot delete; no such customer type', 404);
        }
